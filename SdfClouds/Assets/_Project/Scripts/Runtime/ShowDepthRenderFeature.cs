...
//this is meant as an exercise. I wanto to first read the depth texture and then use this depth texture to set a texture property in a shader
public class ShowDepthRenderFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        {
            const string passName = "Show Depth Texture Pass";
            ...
            using (var builder = renderGraph.AddRasterRenderPass<PassData>(passName, out var passData))
            {
                ...
                var depthTH = resourceData.activeDepthTexture;

                passData.depthTexture = depthTH;
                passData.textureShaderId = Shader.PropertyToID("_DisplayTex");
                ...
                destinationDesc.name = $"destTexture";
                ...
                builder.SetRenderFunc((PassData data, RasterGraphContext context) =>
                {
                    ...
                    //set the m_blitMaterial texture property here
                    
                    RenderGraphUtils.BlitMaterialParameters para = new (source,destination,m_BlitMaterial,0);
                    renderGraph.AddBlitPass(para,"depth tex pass");
