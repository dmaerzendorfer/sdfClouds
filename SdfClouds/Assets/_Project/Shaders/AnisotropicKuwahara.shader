Shader "Hidden/AnisotropicKuwahara" {
    Properties {
        ...
        _KernelSize("kernel Size", Range(2,20)) = 2
        _N ("N", Float) = 8
        _Q ("sharpness", Range(1,18)) = 8
    ...
    SubShader {
        ...
        sampler2D _MainTex, _TFM; //tfm are the eigenvectors
